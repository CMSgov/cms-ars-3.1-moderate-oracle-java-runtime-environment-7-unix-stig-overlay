...
Java Runtime Environment (JRE) 7 on UNIX against
[DISA's](https://iase.disa.mil/stigs/Pages/index.aspx) Oracle JRE 7 UNIX
STIG Version 1 Release 6 tailored for [CMS ARS
...
[issue](https://github.cms.gov/ispg/cms-ars-3.1-moderate-oracle-java-runtime-environment-7-unix-stig-overlay/issues/new).
